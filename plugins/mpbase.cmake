...
function(arcbuild_include_mpbase)
  set(target_path "${CMAKE_BINARY_DIR}/mpbase_bin.zip")
  ...
  if(NOT EXISTS "${target_path}")
    ...
    execute_process(COMMAND cmake -E tar xf "${target_path}" WORKING_DIRECTORY "${CMAKE_BINARY_DIR}")
  endif()
  ...
  set(mpbase_root "${CMAKE_BINARY_DIR}/mpbase_bin.git/${MPBASE_VERSION}")
  if(ARCBUILD_TYPE)
  ...
  arcbuild_find_file(MPBASE_LIBRARY NAMES ${searched_names} PATHS "${mpbase_root}/platform/lib" NO_DEFAULT_PATH)
  arcbuild_find_path(MPBASE_INCLUDE_DIR NAMES ammem.h PATHS "${mpbase_root}/platform/inc" NO_DEFAULT_PATH)
  if(NOT MPBASE_LIBRARY OR NOT MPBASE_INCLUDE_DIR)
    arcbuild_error("Cannot find mpbase library in ${mpbase_root}")
  endif()
  arcbuild_echo("Found mpbase in ${mpbase_root}")
  arcbuild_echo("- Include ${mpbase_root}")
  set(MPBASE "${mpbase_root}" PARENT_SCOPE)
