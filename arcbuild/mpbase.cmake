...
function(arcbuild_get_mpbase_root var_name)
  ...
  set(target_path "${target_dir}/mpbase_bin.tar.gz")
  set(url "http://172.17.10.213/aisg/mpbase_bin/repository/archive.tar.gz")
  if(NOT EXISTS "${target_path}")
    arcbuild_echo("Downloading ${url} to ${target_dir} ...")
    file(DOWNLOAD "${url}" "${target_path}")
    arcbuild_echo("Downloading ${url} [DONE]")
    get_filename_component(target_path "${target_path}" ABSOLUTE)
    execute_process(COMMAND cmake -E tar xf "${target_path}" WORKING_DIRECTORY "${target_dir}")
  endif()
